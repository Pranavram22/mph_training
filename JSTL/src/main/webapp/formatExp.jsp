...
<p> Date &amp; Time short: <strong><fmt:formatDate type="both" datastyle="short" value= "${today}"/></strong></p><br>
<p> Date &amp; Time medium: <strong><fmt:formatDate type="both" value= "${today}"/></strong></p><br>
</body>
</html>